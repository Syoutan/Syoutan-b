    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.ChangeUserSuccess ? "ユーザー情報が変更されました。"
                : "";
        ...
        public ActionResult DeleteUserConfirm()
        {
        ...
        public async Task<ActionResult> ChangeUser()
        {
            ...
            return user == null ? View("Error") : View(new ChangeUserViewModel { Name = user.Name,Email = user.Email,PostNo = user.PostNo,Address1 = user.Address1 });

        }

        // POST: /Manage/ChangeUser
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> ChangeUser(ChangeUserViewModel model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                return RedirectToAction("Index", new { Message = ManageMessageId.ChangeUserSuccess });
            }
            AddErrors(result);
            return View(model);
        }
